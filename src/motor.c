...
int main(int argc, char* argv[]) {
	...
	log_info("#██████╔╝███████╗╚██████╔╝███████║███████║██║  ██║███████╗███████╗███████║███████║#");
	log_info("#╚═════╝ ╚══════╝ ╚═════╝ ╚══════╝╚══════╝╚═╝  ╚═╝╚══════╝╚══════╝╚══════╝╚══════╝#");
	log_info("###################################################################################(a fork of MortorMC https://github.com/garet90/MotorMC)");
	...
	*/
	/*
		The Blusshless project was a rewitten version of MotorMC for a Custom Minecraft Bedrock proxy on Oct 31, 2023
		by Kanison Konkla
	*/
	...
	if (sky_main.motd == NULL) {
		...
		sky_main.motd->text = UTL_CSTRTOSTR("Dedicated Server");
...
void* t_sky_main(__attribute__((unused)) void* input) {
	...
	sch_schedule_repeating(job_new(job_send_update_ping, (job_payload_t) {}), 1, 1);
	...
	if (server) {
		...
		for (uint32_t i = 0; i < server_obj_size; ++i) {
			...
			switch (hash) {
				...
				case 0xc2cd64c2: { // "simulation-distance"
					sky_main.simulation_distance = mjson_get_int(key_val.value);
				} break;
				...
				case 0xa41f2fbe: { // "hide-online-players"
					sky_main.hide_online_players = mjson_get_boolean(key_val.value);
				} break;
...
void sky_gen_server_json() {
	...
	const byte_t server_json[] = {
		...
		
	};
